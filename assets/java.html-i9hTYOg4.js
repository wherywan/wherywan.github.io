import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as p,c as t,a as s,b as n,d as c,e as a}from"./app-CROQkPnG.js";const o={},r=a(`<h1 id="java" tabindex="-1"><a class="header-anchor" href="#java"><span>java</span></a></h1><h2 id="运算符优先级" tabindex="-1"><a class="header-anchor" href="#运算符优先级"><span>运算符优先级</span></a></h2><h2 id="知识点" tabindex="-1"><a class="header-anchor" href="#知识点"><span>知识点</span></a></h2><p>文件写入不到build的resource目录下</p><h2 id="集合" tabindex="-1"><a class="header-anchor" href="#集合"><span>集合</span></a></h2><p>最上层的Collections和Map接口</p><p>其中List和Set接口继承Collections</p><p>常用的是ArrayList和HashMap和HashSet</p><ul><li><p>List</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="shiki light-plus" style="background-color:#FFFFFF;color:#000000;" tabindex="0"><code><span class="line"><span>ArrayList和LinkedList是其实现类，元素顺序是有序的，容量10</span></span>
